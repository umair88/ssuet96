...
<ul class="topnav" id="myTopnav">
  ...
  <br><h1>SSUET Batch 1996-2000</h1>
...
<div class="radios">
<div style="color:white; font-size:12px;">Gender</div>
...
<!-- <label>Your Message <span class="required">*</span></label>
        <textarea name="message" id="message" class="tb1" style= " width=100%" placeholder="Please Enter Your Message" 
